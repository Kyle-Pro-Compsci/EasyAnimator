...
public class Oval extends Shape {
  ...
  public Oval(Coordinate coordinate, Color color, String name, int startTime, int endTime,
  ...
  @Override
  public IShape copy() {
    return new Oval(new Coordinate(this.coordinate),
